...
class SettingTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testSetting()
    {
        ...
        // Give
        $db_morph_1 = factory(Setting::class)->create(['morph_id' => 1]);
        $db_morph_2 = factory(Setting::class)->create(['morph_id' => 2]);
        $db_morph_3 = factory(Setting::class)->create(['morph_id' => 3, 'is_enabled' => 1]);
