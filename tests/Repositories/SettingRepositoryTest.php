...
use WalkerChiu\Firewall\Models\Repositories\SettingRepository;
...
class SettingRepositoryTest extends \Orchestra\Testbench\TestCase
{
     ...
     * @return void
     */
    public function testFirewallRepository()
    {
        // Config
     ...
     *     WalkerChiu\Firewall\Models\Repositories\SettingRepository
     * 
     * @return void
     */
    ...
    public function testFormTrait()
    {
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Setting::class)->create(['serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(Setting::class)->create(['serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(Setting::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
